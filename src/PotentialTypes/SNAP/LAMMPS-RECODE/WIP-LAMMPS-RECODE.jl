# The following is code that is being ported to Julia, it is based off of the SNA implementation in LAMMPS (see original 
# attribution below).
...
function SNA(snap::SNAP)

  #Computes the number of coefficients and matrix holding coefficients
  ncoeff, idxb, idxz, idxcg = compute_ncoeff_build_list(snap.twojmax, snap.keywords.n_elements, snap.keywords.chem_flag)
