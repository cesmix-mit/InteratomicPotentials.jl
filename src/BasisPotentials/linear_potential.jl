...
force(s::AtomsBase.AbstractSystem, lbp::LBasisPotential) = force(get_force_descriptors(s, lbp.basis), lbp)
...
virial_stress(sys::AtomsBase.AbstractSystem, lbp::LBasisPotential) = virial_stress(get_virial_descriptors(sys, lbp.basis), lbp)
